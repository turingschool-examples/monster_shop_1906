...
describe User do
  ...
  describe 'roles' do
    ...
    it 'can be created as an admin' do
      user = User.create(name: 'Ross', address: '56 HairGel Ave', city: 'Las Vegas', state: 'Nevada', zip: '65041', e_mail: 'dinosaurs_rule@gmail.com', password: 'rachel', role: 1)
    ...
    it 'can be created as a merchant employee' do
      user = User.create(name: 'Joey', address: '76 Pizza Place', city: 'Brooklyn', state: 'New York', zip: '10231', e_mail: 'estelles_best_actor@gmail.com', password: 'letseat', role: 2)
    ...
    it 'can be created as a merchant admin' do
      user = User.create(name: 'Monica', address: '45 Squeaky Clean St', city: 'Portland', state: 'Maine', zip: '12341', e_mail: 'number_one_chef@gmail.com', password: 'chandlerbing', role: 3)
