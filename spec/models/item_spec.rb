...
describe Item, type: :model do
  ...
  describe "instance methods" do
    ...
    it 'can find the quantity ordered of an item' do
      order_1 = Order.create!(name: "Joe", address: "748 Main St", city: "Denver", state: "CO", zip: 80128)
      order_2 = Order.create!(name: "Bob", address: "818 Johnson Ave", city: "Miami", state: "FL", zip: 32946)
