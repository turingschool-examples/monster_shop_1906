...
RSpec.describe "Items Index Page" do
  describe "When I visit the items index page" do
    ...
    it "I can visit the items catalog, I see all items in the system except disabled items
    The item image is a link to that item's show page" do
      visit '/items'
