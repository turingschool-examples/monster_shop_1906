...
RSpec.describe 'merchant show page', type: :feature do
  describe 'As a user' do
    before :each do
      ...
      @order_1 = Order.create!(user_id: user.id, name: 'Meg', address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17033)
      @order_2 = Order.create!(user_id: user.id, name: 'Brian', address: '123 Zanti St', city: 'Denver', state: 'CO', zip: 80204)
      @order_3 = Order.create!(user_id: user.id, name: 'Mike', address: '123 Dao St', city: 'Denver', state: 'CO', zip: 80210)
