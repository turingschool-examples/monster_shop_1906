...
RSpec.describe 'Users Order Show Page' do
  describe 'when a logged in user has placed orders' do
    ...
    expect(page).to have_content("Total Order Item Count: #{@order_1.item_orders.count}")
    expect(page).to have_content("Total Order Item Count: #{@order_2.item_orders.count}")
    expect(page).to have_content("Total Order Item Count: #{@order_3.item_orders.count}")
