...
RSpec.describe 'User login page' do
  ...
  describe 'merchant user' do
    before :each do
      @employee = User.create!(name: "Gmoney", address: "123 Lincoln St", city: "Denver", state: "CO", zip: 23840, email: "test1@gmail.com", password: "password123", password_confirmation: "password123", role: 1)
